...
#reader.SetFileName("openfoam_case/VTK/openfoam_case_2/boundary/stl.vtp")
#reader.Update()
...
if __name__ == "__main__":
    vtp_data = read_data("openfoam_case/VTK/openfoam_case_2/boundary/stl.vtp")
    vtu_data = convert_vtp_to_vtu(vtp_data)
    write_data(vtu_data, "converted_mesh.vtu")
